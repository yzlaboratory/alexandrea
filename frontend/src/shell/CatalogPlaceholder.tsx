...
// Library) and for a Catalog route whose :mediaType isn't one of the
// four known values — "coming soon" would be wrong for the latter, so
// the copy stays neutral enough to be true for both.
