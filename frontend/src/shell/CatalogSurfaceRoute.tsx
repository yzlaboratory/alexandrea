...
// This route is matched on "/:mediaType/catalog" — a dynamic :mediaType
// segment covering all four media types, not a movies-only static path —
// so AppShell's useParams()-driven tab highlighting (which media-type tab
// and which surface tab is active) keeps working here exactly like it does
// on every other surface route.
function CatalogSurfaceRoute(): ReactNode {
  ...
  if (isMediaType(mediaType)) {
    // key={mediaType}: CatalogPage owns the transient search box, and
