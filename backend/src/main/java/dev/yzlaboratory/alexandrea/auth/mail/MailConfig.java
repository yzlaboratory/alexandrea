 ...
 * outside prod. The region is pinned rather than left to the SDK's own
 * resolution because ADR 0023 fixes compute to eu-central-1 regardless of
 * where the JVM happens to run.
 */
@Configuration
...
public class MailConfig {
    ...
    public SesV2Client sesV2Client() {
        return SesV2Client.builder().region(Region.EU_CENTRAL_1).build();
    }
