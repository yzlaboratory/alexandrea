 ...
 * {@code filters} carries only the fields currently set, keyed by filter
 * field (genre, originalLanguage, availableInLanguage); an absent field
 * means no value is selected for it.
 */
